...
export default function ShortCTA() {
  return (
    <section className="bg-white p-5 lg:px-10 xl:px-20 2xl:px-[162px] 2xl:py-[60px]">
      <div className="mx-auto flex w-full max-w-[1738px] flex-col items-center gap-[26px] rounded-[40px] px-5 py-5 lg:flex-row lg:justify-center lg:gap-[60px] lg:px-10 xl:px-20 2xl:px-[100px]">
        <h2 className="max-w-[270px] text-center text-[24px] font-semibold leading-[30px] tracking-[-0.005em] text-[#00BAFA] lg:max-w-[478px] lg:text-[36px] lg:leading-[45px]">
